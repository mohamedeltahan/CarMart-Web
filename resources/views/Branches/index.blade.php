...
<html lang="en">
  ...
  <body>
	...
	<div class="d-none">
		<form id="DeleteForm" action="" method="post" data-link="{{route("branches.destroy","")}}">
			@method("delete")
			@csrf
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-4">
					<a href="{{route("branches.index")}}" style="color: white">	<h2>Manage <b>Branches</b></h2> </a>
					</div>
					<div class="col-sm-4">
						<form method="post" action="{{route("branches.search")}}">
