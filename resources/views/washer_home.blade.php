            ...
            <div class="row">
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Top 100 Offers From<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{App\Models\Offer::count()}}</h2>
                    <h6 class="card-text"><a href="">Export To Excel</a> </h6>
                  </div>
                </div>
              </div>
...
if ($("#customersbarChart").length) {
 ...
 var barChart = new Chart(barChartCanvas, {
  ...
  $("#MostBranches option").each(function(i){
    labels.push($(this).text());
    data.push($(this).val());
  });
 var data = {
