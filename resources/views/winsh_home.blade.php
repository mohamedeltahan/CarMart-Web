...
<style>
  ...
  <body>
      ...
      <select id="MonthlyRequests">
        @foreach($monthly_requests as $key=>$value)
        <option value="{{$value}}">{{$key}}</option>
        @endforeach
      </select>
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Requests Received<i class="mdi mdi-bookmark-check mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Requests Completed<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{App\Models\UserService::where("vendor_id",Auth::id())->where("state","completed")->count()}}</h2>
                    <h6 class="card-text"> </h6>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Requests Rejected<i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{App\Models\UserService::where("vendor_id",Auth::id())->where("state","rejected")->count()}}</h2>
                    <h6 class="card-text">  </h6>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-lg-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Requests Traffic</h4>
                      <canvas id="requestsbarchart" style="height:250px"></canvas>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 grid-margin stretch-card">
...
if ($("#customersbarChart").length) {
 ...
 var barChart = new Chart(barChartCanvas, {
  ...
  $("#MonthlyRequests option").each(function(i){
    labels.push($(this).text());
    data.push($(this).val());
  });
 var data = {
...
if ($("#requestsbarchart").length) {
 var barChartCanvas = $("#requestsbarchart").get(0).getContext("2d");
 // This will get the first returned node in the jQuery collection.
 var barChart = new Chart(barChartCanvas, {
   type: 'bar',
   data: data,
