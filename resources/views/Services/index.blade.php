...
<style>
  ...
  <body>
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Total Services<i class="mdi mdi-bookmark-check mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{App\Models\Service::where("vendor_id",Auth::id())->count()}}</h2>
              ...
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;"> 
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Highest Service sales <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{App\Models\Service::Highest_Service_Sells(1)->en_title}}</h2>
                    <h6 class="card-text">{{App\Models\Service::Highest_Service_Sells(1)->count}}</h6>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin" style="height: 156px;">
                            ...
                            <table class="table table-striped table-hover" style="text-align: center"  id="MainTable"> 
                                ...
                                <tbody>
                                   @if(Auth::user()->category_title=="car_washer")
                                    ...
                                    <tr  data-id="{{$service["id"]}}" data-en_title="{{$service["en_title"]}}" data-en_description="{{$service["en_description"]}}" data-branches="{{App\Models\Service::find($service["id"])->GetBranches()}}" data-available_from="{{$service["available_from"]}}" data-available_to="{{$service["available_to"]}}" data-en_category="{{$service["en_category"]}}">
                                        <td class="en_title">{{$service["en_title"]}}</td>
                                   ...
                                   @elseif(Auth::user()->category_title=="supplier")
                                      @foreach($services["data"] as $service)				
                                      <tr  data-id="{{$service["id"]}}" data-title="{{$service["id"]}}" data-en_description="{{$service["en_description"]}}" data-branches="{{App\Models\Service::find($service["id"])->GetBranches()}}" data-available_from="{{$service["available_from"]}}" data-available_to="{{$service["available_to"]}}" data-en_category="{{$service["en_category"]}}">
                                        <td class="en_title">{{$service["en_title"]}}</td>
                                        ...
                                        <td class="en_color">{{$service["en_color"]}}</td>
                                        <td class="promote_td"> 
                            ...
                            <div class="modal-body">					
                                        ...
                                        <div class="col-sm-4">
                                         ...
                                         <div class="col-sm-4">
                                          ...
                                          <div class="col-sm-4">
                                            ...
                                            <span class="astric">&#42;</span>
                                            <select   name="en_category" class="form-control ">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-4">
                                            ...
                                            <textarea required type="text" name="en_description" class="form-control" rows="4"   > </textarea>
                                          </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-4">
                                            <label>Color</label>
                                            <span class="astric">&#42;</span>
                                            <input required type="text" name="en_color" class="form-control">
                                          </div>
                                          <div class="col-sm-4">
                            ...
                            <div class="modal-body">					
                              ...
                              <div class="form-row">
                                  <div class="col-sm-6">
                                      <label>Description</label>
                                      <span class="astric">&#42;</span>
                                      <textarea required type="text" name="en_description" class="form-control"   > </textarea>
                                    </div>
    ...
    $(document).on("click",".edit_row",function(){
      ...
      var en_description=targeted_row.attr("data-en_description");
      ...
      var en_color=targeted_row.find(".en_color").text();
      ...
      var en_category=targeted_row.attr("data-en_category");
...
*/
      ...
      $("#EditServiceModal").find("input[name=en_title]").val(en_title);
      $("#EditServiceModal").find("input[name=type]").val(type);

      $("#EditServiceModal").find("select[name=en_category]").val(en_category);
      $("#EditServiceModal").find("input[name=discount]").val(discount);
      $("#EditServiceModal").find("textarea[name=en_description]").val(en_description);
      ...
      $("#EditServiceModal").find("input[name=en_color]").val(en_color);
