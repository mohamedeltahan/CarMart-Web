...
<html lang="en">
  ...
  <!---temp subcategory to add it to Form and fill it  --->
	...
	<div class="d-none">
		<form id="DeleteForm" method="post" data-link="{{route("specifications.destroy","")}}">
			@method("delete")
      @csrf
...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-4">
					<a href="{{route("photos.index","icons")}}" style="color: white">	<h2>Manage <b>Specifications</b></h2> </a>
					</div>
					...
					<div class="col-sm-4">
						<a href="#AddPhotoModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Specification</span></a>
					</div>
				</div>
			</div>
		@if($errors->any())
        ...
        <table class="table table-striped table-hover" style="text-align: center"  id="MainTable"> 
          ...
          <tbody>
            ...
            <tr data-id="{{$specification->id}}">
              <td class="en_title">{{$specification->en_title}}</td>
              <td class="ar_title">{{$specification->ar_title}}</td>
              <td class="en_specification_category">{{$specification->en_specification_category}}</td>
              <td class="ar_specification_category">{{$specification->ar_specification_category}}</td>
              <td class="image"><img src="{{asset("specifications-photos/".$specification->image_link)}}"></td>
              <td ><i class="fa fa-pencil-square-o edit_row" href="#EditSpecificationModal"  data-toggle="modal" aria-hidden="true"></i></td>
              <td><i data-path="{{asset("specifications-photos/".$specification->image_link)}}" class="fa fa-trash-o delete_row" data-toggle="modal" href="#DeletePhotoModal" aria-hidden="true"></i></td>
        ...
        <div class="clearfix">
          ...
          <!-- content-wrapper ends -->
            ...
            <!-- Users Modal --!>
                      ...
                      <form method="post" action="{{route("specifications.store")}}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">					
                          ...
                          <div class="form-group">
                            ...
                            <input required type="text"  class="form-control" name="ar_title" >
                          </div>
                          <div class="form-group">
                            <label>English Title</label>
                            <span class="astric">&#42;</span>
                            <input required type="text"  class="form-control" name="en_title" >
                          </div>

                          <div class="form-group">
                            <label>Category</label>
                            <span class="astric">&#42;</span>
                            <select required name="en_specification_category" class="form-control">
                          ...
                          <div class="form-group">
                            <label>Image</label>
                            <span class="astric">&#42;</span>
                            <input required type="file" class="form-control"  name="image_link" >
                          ...
                          <div class="form-group d-none">
                            ...
                            <select required class="form-control"  name="folder_name">
                                <option value="specifications-photos" selected>specifications-photos</option>
                ...
                <!-- Edit Modal HTML -->
                <div id="EditSpecificationModal" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form id="EditForm" method="post" data-link="{{route("specifications.update","")}}" action="" enctype="multipart/form-data">
                        @csrf
                        @method("put")
                        <div class="modal-header">						
                        ...
                        <div class="modal-body">					
                          <div class="form-group">
                            <label>English Title</label>
                            <span class="astric">&#42;</span>
                            <input type="text"  name="en_title" class="form-control  en_title" required>
                          </div>

                          <div class="form-group">
                            <label>Arabic Title</label>
                            <span class="astric">&#42;</span>
                            <input type="text"  name="ar_title" class="form-control  ar_title" required>
                          </div>
    ...
    $(document).on("click",".edit_row",function(){
      ...
      var en_specification_category=targeted_row.find(".en_specification_category").val();

      $("#EditSpecificationModal").find(".ar_title").val(ar_title);
      $("#EditSpecificationModal").find(".en_title").val(en_title);
